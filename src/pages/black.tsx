...
export default function Black() {
  ...
  if (loading) return <p className="p-4">Loading black cards…</p>
  if (error)   return <p className="p-4 text-red-600">{error}</p>
  if (cards.length === 0) return <p className="p-4">No black cards found.</p>
